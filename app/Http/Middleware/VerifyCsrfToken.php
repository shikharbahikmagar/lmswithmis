...
class VerifyCsrfToken extends Middleware
{
    ...
    protected $except = [
        ...
        "/admin/update-teacher-status", "/admin/check-teacher-current-pwd", "/admin/teacher-schedules",
         ...
         "/admin/update-notice-status", "/admin/update-banner-status", "/show-filtered-notices", "/admin/update-event-status", "/admin/update-event-category-status", "/student/check-current-pwd", "/admin/update-book-request-status", "/library"
    ];
}
