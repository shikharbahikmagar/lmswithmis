         ...
         <div class="row">
            ...
            <div class="col-md-6">
               ...
               <div class="card card-primary">
                  ...
                  <!-- form start -->
                  <form
                  @if(empty($noticeCategory['id']))
                  action="{{ url('/admin/add-edit-notice-category') }}"
                  @else
                  action="{{ url('/admin/add-edit-notice-category/'.$noticeCategory['id']) }}"
                  @endif
                  ...
                  <div class="card-body">
                     <div class="form-group">
                        ...
                        @if(!empty($noticeCategory)) value="{{ $noticeCategory->category_name }}" @else value="{{ old('category_name') }}" @endif>
                     </div>
                  <!-- /.card-body -->
