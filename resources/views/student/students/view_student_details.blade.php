                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input readonly type="file" class="form-control" id="teacher_image" name="teacher_image">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <!-- <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                           <input readonly type="password" class="form-control" name="password" id="password" placeholder="Enter password"
                            @if(!empty($teacherData['password'])) Readonly @endif>
                            <input readonly type="hidden" @if(!empty($teacherData['password'])) value="{{ $teacherData['password'] }}" @endif name="old_password">
